                ...
                <tbody>
                    <tr>
                        ...
                        <td style={{lineHeight:'12pt', height:'10px'}}>
                            ...
                            <span className="topsel"><Link to="new">new</Link></span> | <Link to="ask" className='ml-1 text-decoration-none'>ask</Link> | <Link to="show">show</Link> | <Link to="jobs">jobs</Link>| <Link to="Comment">comment</Link>| <Link to="submit">submit</Link>|</span>
                        </td>
